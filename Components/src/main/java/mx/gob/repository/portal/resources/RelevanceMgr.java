...
public class RelevanceMgr extends GenericResource {
    ...
    private static final Logger LOG = SWBUtils.getLogger(RelevanceMgr.class);
    ...
    public void doView(HttpServletRequest request, HttpServletResponse response, SWBParamRequest paramRequest) throws SWBResourceException, IOException {
        ...
        String path = "/work/models/"+paramRequest.getWebPage().getWebSite().getId()+"/jsp/rnc/collections/homecollection.jsp";
        ...
        try {
            ...
            if (!this.getResourceBase().getAttribute("userid", "").isEmpty()) {
                ...
                setCovers(request, paramRequest, collections, 3);
                ...
                collectionList = collectionById(request, this.getResourceBase().getAttribute("collectionID", ""), paramRequest.getWebPage().getWebSite());
    ...
    private List<Collection> collectionByUserId(String id, WebSite site) throws SWBResourceException, IOException {
        ...
        base += "/api/"+version+"/search?identifier=";
        try {
    ...
    private List<Entry> collectionById(HttpServletRequest request, String id, WebSite site) throws SWBResourceException, IOException {
        @SuppressWarnings("UnusedAssignment")
    ...
    private Entry getEntry(HttpServletRequest request, String uri) {
        Entry e = ArtDetail.getEntry(request, uri);
