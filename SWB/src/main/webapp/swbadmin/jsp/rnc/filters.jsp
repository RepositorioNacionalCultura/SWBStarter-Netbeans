...
<div id="sidebar">
    ...
    <%	if (null != resourcetypes && !resourcetypes.isEmpty()) { %>
        <div class="card">
            <div class="" role="tab" id="headingOne">
                <a data-toggle="collapse" href="#collapse1" aria-expanded="true" aria-controls="collapseOne" class="btnUpDown collapsed"><%=paramRequest.getLocaleString("usrmsg_view_search_themes")%> <span class="mas">+</span><span class="menos">-</span></a>
            </div>
	...
	<%  if (null != mediastype && !mediastype.isEmpty()) { %>
        <div class="card">
            <div class="" role="tab" id="headingOne">
                <a data-toggle="collapse" href="#collapse2" aria-expanded="true" aria-controls="collapseOne" class="btnUpDown collapsed"><%=paramRequest.getLocaleString("usrmsg_view_search_media")%> <span class="mas">+</span><span class="menos">-</span></a>
            </div>
	...
	<%  if (!dates.isEmpty()) { %>
        <div class="card">
            <div class="" role="tab" id="headingOne">
                <a data-toggle="collapse" href="#collapse3" aria-expanded="true" aria-controls="collapseOne" class="btnUpDown collapsed"><%=paramRequest.getLocaleString("usrmsg_view_search_date")%> <span class="mas">+</span><span class="menos">-</span></a>
            </div>
	...
	<%  if (null != rights && !rights.isEmpty()) { %>
        <div class="card">
            <div class="" role="tab" id="headingOne">
                <a data-toggle="collapse" href="#collapse4" aria-expanded="true" aria-controls="collapseOne" class="btnUpDown collapsed"><%=paramRequest.getLocaleString("usrmsg_view_search_rights")%> <span class="mas">+</span><span class="menos">-</span></a>
            </div>
	...
	<%  if (null != languages && !languages.isEmpty()) { %>
        <div class="card">
            <div class="" role="tab" id="headingOne">
                <a data-toggle="collapse" href="#collapse5" aria-expanded="true" aria-controls="collapseOne" class="btnUpDown collapsed"><%=paramRequest.getLocaleString("usrmsg_view_search_languages")%> <span class="mas">+</span><span class="menos">-</span></a>
            </div>
    ...
    <% if (!holders.isEmpty()) { %>
        <div class="card">
            <div class="" role="tab" id="headingOne">
                <a data-toggle="collapse" href="#collapse6" aria-expanded="true" aria-controls="collapseOne" class="btnUpDown collapsed"><%=paramRequest.getLocaleString("usrmsg_view_search_holder")%> <span class="mas">+</span><span class="menos">-</span></a>
            </div>
