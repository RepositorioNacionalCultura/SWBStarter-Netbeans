...
<%@page import="org.semanticwb.portal.api.SWBParamRequest, org.semanticwb.portal.api.SWBResourceURL"%>
...
<%
	...
	urlNewVersion.setCallMethod(SWBParamRequest.Call_DIRECT);
...
<html>
    <head>
        ...
        <title>HTML Culture Editor</title>
