...
<link rel='stylesheet' type='text/css' media='screen' href='/work/models/repositorio/css/viewer-epub.css'/>
...
<section id="detalle">
	<div id="idetail" class="detalleimg">
		<div class="obranombre">
		 ...
		 <div id="main">
			<div id="prev" onclick="Book.prevPage();" class="arrow"><span class="ion-chevron-left"></span></div>
			<div id="area"></div>
			<div id="next" onclick="Book.nextPage();" class="arrow"><span class="ion-chevron-right"></span></div>
		</div>
	</div>
</section>
<script>
