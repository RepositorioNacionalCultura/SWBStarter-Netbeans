...
<link rel='stylesheet' type='text/css' media='screen' href='/work/models/repositorio/css/viewer-pdf.css'/>
...
<section id="detalle">
	<div id="idetail" class="detalleimg">
		<div class="obranombre">
             <h3 class="oswB">Nombre del Archivo</h3>
...
<script type="text/javascript">
  $(document).ready(function(){
    PDFObject.embed("http://www.pdf995.com/samples/pdf.pdf", "#pdfdetail");
  });
</script>