...
<section id="detalle">
	<div id="idetail" class="detalleimg">
		<div class="obranombre">
             <h3 class="oswB">La chica de la Ventana</h3>
             <p class="oswL">Abraham Ángel</p>
         </div>
		 <div class="explora">
			<div class="explora2">
				<div class="explo1">
		 ...
		 <video width="97%" poster="/work/models/cultura/img/nina.jpg" controls controlsList="nodownload">
