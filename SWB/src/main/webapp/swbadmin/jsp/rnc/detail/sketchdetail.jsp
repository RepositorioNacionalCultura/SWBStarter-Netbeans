...
<section id="detalle">
	<div id="idetail" class="detalleimg">
		<div class="obranombre">
             <h3 class="oswB">Xipe Tótec en Teotihuacan</h3>
             <p class="oswL">INAH</p>
         </div>
		 <div class="explora">
			<div class="explora2">
		 ...
		 <iframe width="1280" height="860" src="" id="api-frame" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
	</div>
</section>
...
<style type="text/css">
.explora, .obranombre { bottom:60px}
iframe#api-frame { height:100%; width:100%; border:none}
</style>

<script type="text/javascript">
    var iframe = document.getElementById( 'api-frame' );
    var urlid = '9e898967d93e406e8a1aecf878caec21';
