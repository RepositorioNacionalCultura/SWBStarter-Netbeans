...
<link rel='stylesheet' type='text/css' media='screen' href='/work/models/repositorio/css/viewer-video-2.css'/>
...
<section id="detalle">
	<div id="idetail" class="detalleimg">
		...
		<div id="video-controls" class="row">
            <div class="col-11 col-md-7 video-players">
                <div class="col-12 video-botones">
                    <button type="button" id="prev" class="prev"><span class="ion-ios-skipbackward"></span></button>
                    
                    <button type="button" id="play-pause" class="play"><span class="ion-ios-play"></span></button>
                    
                    <button type="button" id="next" class="next"><span class="ion-ios-skipforward"></span></button>
                </div>
                <div class="col-12 video-range">
                    <span class="video-time oswM">0:00:00</span>
                    <input type="range" id="seek-bar" value="0">
                    <span class="video-duration oswM">0:00:00</span>
                </div>
            </div>
            <div class="col-4 video-volumen">
               <div class="row">
                   <div class="col-3 col-sm-3 col-md-2 video-volbtn">
                       <button type="button" id="mute"><span class="ion-ios-volume-high"></span></button>
                   </div>
                   <div class="col-8 col-sm-9 col-md-10 video-volrange">
                       <input type="range" id="volume-bar" min="0" max="1" step="0.1" value="1">
                   </div>
               </div>
                
            </div>
            <div class="col-1 video-screen">
