...
var eng = {
    ...
    dataSourceServlet:"/datasource",
    
    exportServlet:"/export",
                    ...
                    data:[
                        {title:"Exportar Vista", icon: "[SKIN]/actions/download.png", 
                            click:function()
                            {
                                ...
                                var path=eng.exportServlet+grid.getDataSource().dataURL.substring(3)+"&ext=xls"+"&data="+encodeURI(JSON.stringify(data));
