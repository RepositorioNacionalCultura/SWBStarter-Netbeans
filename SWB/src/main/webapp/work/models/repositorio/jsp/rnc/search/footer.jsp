    ...
    <div class="container">
        ...
        <div class="row datos">
            <div class="col-7 col-sm-6 col-md-4 col-lg-4 datos1">
                <ul>
                    <li><a href="/<%=userlang%>/<%=siteid%>/somos">Quiénes somos y qué hacemos</a></li>
                    <li><a href="/<%=userlang%>/<%=siteid%>/proveedores">Nuestros proveedores de datos</a></li>
                    <li><a href="/<%=userlang%>/<%=siteid%>/colaborar">Cómo colaborar con nosotros</a></li>
                </ul>
            </div>
            <div class="col-5 col-sm-6 col-md-4 col-lg-4 datos2">
                <ul>
                    <li><a href="/<%=userlang%>/<%=siteid%>/derechos">Declaración de derechos</a></li>
                    <li><a href="/<%=userlang%>/<%=siteid%>/documentacion-tecnica">Documentación</a></li>
                    <li><a href="/<%=userlang%>/<%=siteid%>/red-preservacion">Red de Preservación</a></li>
                </ul>
            </div>
            <hr class="d-md-none" />
            ...
            <div class="col-5 col-sm-6 col-md-12 col-lg-12 datos4">
                <ul class="row">
                    ...
                    <li class="col-md-4"><a href="/<%=userlang%>/<%=siteid%>/terminos">Términos de uso</a></li>
                </ul>
            </div>
        </div>
    </div>
