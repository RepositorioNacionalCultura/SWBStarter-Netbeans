...
<%
    ...
    String w = null != request.getAttribute("criteria") ? (String) request.getAttribute("criteria") : "paramnull";
%>
<div id="pages" class="container paginacion">
    <ul class="azul">
        ...
        <li><a href="#"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></a></li>
                ...
                %>
        <li><a class="fa fa-long-arrow-left" aria-hidden="true" title="anterior" href="javascript:doPage('<% out.print(w + "'," + primeraPaginaBloqueAnterior + ",'" + m + ",'" + f); %>')">&nbsp;</a></li>
            <%
                    }
                }
            %>
        ...
        <%
            for (int i = paginaInicialBloque; i <= paginaFinalBloque; i++) {
                if (i == paginaActual) {
                    ...
                    out.println("<li><a href=\"#\" onclick=\"javascript:doPage('" + w + "'," + i + ",'" + m + "','" + f + "')\">" + i + "</a></li>");
                }
            }
        %>
        ...
        <li><a href="#"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
                ...
                %>
        <li><a href="#" onclick="doPage('<% out.print(w + "'," + primeraPaginaBloqueSiguiente + ",'" + m + ",'" + f);%>')"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></a></li>
                <%
                        }
                    }
                %>
